...
image_dir = r'C:\\파이썬 1조\\상의 목록\\스포츠\\spring_sports_high'
...
##########################################################
csv_file = 'C:\\파이썬 1조\\상의 목록\\스포츠\\spring_sports_high.csv'
if ext in ['.jpg', '.jpeg', '.png', '.gif']:
        # 이미지 파일의 전체 경로 생성
        file_path = os.path.join("C:\\\\파이썬 1조\\\\상의 목록\\\\스포츠\\\\spring_sports_high\\\\", str(i+1))
...
image_dir1 = r'C:\\파이썬 1조\\하의 목록\\스포츠\\spring_training_low'
...
# 변환 후 인터페이스 실행 시 다시 파일 형식 복구 필수    #
##########################################################
csv_file1 = 'C:\\파이썬 1조\\하의 목록\\csv파일\\스포츠\\spring_training_low_read.csv'
...
for i, file_name1 in enumerate(image_files1):
    ...
    if ext1 in ['.jpg', '.jpeg', '.png', '.gif']:
        # 이미지 파일의 전체 경로 생성
        file_path1 = os.path.join("C:\\\\파이썬 1조\\\\하의 목록\\\\스포츠\\\\spring_training_low\\\\", str(i+1))
