...
image_dir = r'C:\\파이썬 1조\\상의 목록\\summer_street_short_sleeved\\resize'
...
##########################################################
csv_file = 'C:\\파이썬 1조\\상의 목록\\csv 파일\\summer_street_short_sleeved_test.csv'
...
for i, file_name in enumerate(image_files):
    ...
    if ext in ['.jpg', '.jpeg', '.png', '.gif']:
        # 이미지 파일의 전체 경로 생성
        file_path = os.path.join("C:\\\\파이썬 1조\\\\상의 목록\\\\summer_street_short_sleeved\\\\resize\\\\", str(i+1))
